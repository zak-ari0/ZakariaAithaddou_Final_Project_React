...
function Contact() {
  return (
    <main className="container mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:space-x-8 px-4 md:px-8 lg:px-16 mb-36">
        <form className="w-full md:w-1/2 space-y-6">
          ...
          <input
            ...
            className="w-full md:w-[90%] border border-gray-300 px-4 py-3 outline-none focus:ring-2 focus:ring-gray-400"
          />
          <input
            type="email"
            name="email"
          ...
          <button
            type="submit"
            className="w-full md:w-[28%] bg-black text-[17px] font-light tracking-wide text-white py-2.5 rounded-full hover:bg-[#E65540] transition ease-in duration-300 cursor-pointer"
          >
            SEND
          </button>
        </form>

        <div className="w-full md:w-1/2 mt-8 md:mt-0 h-80 md:h-96">
          <iframe
